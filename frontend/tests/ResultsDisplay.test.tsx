...
describe('ResultsDisplay', () => {
  ...
  it('renders awareness snapshot cards', () => {
    render(<ResultsDisplay result={mockResult} />);
    expect(screen.getByText(/biggest source/i)).toBeInTheDocument();
    expect(screen.getByText(/cut to global average/i)).toBeInTheDocument();
    expect(screen.getByText(/paris-aligned pace/i)).toBeInTheDocument();
  });
